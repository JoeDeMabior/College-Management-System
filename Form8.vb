...
Public Class Form8
    ...
    Sub display()
        txtID.Text = rs.Fields("AdminID").Value
    ...
    Sub refreshData()
        rs.Close()
        rs.Open("Select * from AdminsProfile", con, ADODB.CursorTypeEnum.adOpenStatic, ADODB.LockTypeEnum.adLockPessimistic)
        If Not rs.EOF Then
            rs.MoveNext()
            display()
        Else
    ...
    Private Sub cmdSave_Click(sender As Object, e As EventArgs) Handles cmdSave.Click
        rs.Fields("AdminID").Value = txtID.Text
        ...
        If str = "" Then
            MsgBox("Please Upload a Photo for the Admin.", MsgBoxStyle.Critical)
        Else
    ...
    Private Sub cmdDelete_Click(sender As Object, e As EventArgs) Handles cmdDelete.Click
        ...
        confirm = MsgBox("Do You Really Want to Delete This Admin Profile?", MsgBoxStyle.YesNo + MsgBoxStyle.Critical, "Deletion Confirmation")
    ...
    Private Sub cmdSearch_Click(sender As Object, e As EventArgs) Handles cmdSearch.Click
        rs.Close()
        rs.Open("Select * from AdminsProfile where AdminID = '" + txtID.Text + "'", con, ADODB.CursorTypeEnum.adOpenDynamic, ADODB.LockTypeEnum.adLockPessimistic)
        If Not rs.EOF Then
            display()
            reload()
        Else
